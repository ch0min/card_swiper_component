export default [
    {
        id: "1",
        name: "Bill Gates",
        image: require("../../assets/images/gates.png"),
    ...
    },
    {
        ...
        desc: "Musk was born in Pretoria, South Africa, and briefly attended the University of Pretoria before " +
    ...
    },
    {
        id: "3",
        name: "Zuck",
        image: require("../../assets/images/zuck.png"),
        bio: "No need to send me your nudes, I already saw them",
        desc: "Zuckerberg attended Harvard University, where he launched Facebook in February 2004 " +
    ...
    },
    {
        id: "4",
        name: "Jeffrey Bezos",
        image: require("../../assets/images/bezos.png"),
        bio: "You are amazonly beautiful",
        desc: "Born in Albuquerque and raised in Houston and Miami, " +
